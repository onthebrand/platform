...
const CtaBannerSection = () => {
  return (
    <section className="bg-[#ffeb3b] py-16">
      {/* --- CAMBIO AQUÍ --- */}
      {/* Modificamos las clases 'flex' para un comportamiento responsive */}
      <div className="container mx-auto px-4 flex flex-col md:flex-row items-center justify-between gap-8 md:gap-12">
        ...
        <div className="flex-shrink-0 flex items-center gap-6">
          ...
          <a href="#precios" className="hidden lg:flex font-semibold text-gray-800 hover:text-purple-600 items-center gap-2 whitespace-nowrap">
