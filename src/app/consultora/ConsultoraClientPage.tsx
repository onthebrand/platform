"use client";
// src/app/consultora/ConsultoraClientPage.tsx
...
import ConsultoraHeader from "./ConsultoraHeader";
...
export default function ConsultoraClientPage() {
