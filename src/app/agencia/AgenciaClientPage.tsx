...
const plans = [
  ...
  },
  {
    ...
    features: [
      "Campañas Google Search (Red de Búsqueda)",
      "Campañas Performance Max o Meta (Facebook / Instagram)",
      "Gráficas y Videos con IA",
      "Marcación GTM, GA4 y Ads.",
      "Dashboard de resultados",
      "Asistencia vía correo",
    ],
  ...
  {
    name: "Plan Pro",
    price: "$490.000", // Se mantiene el precio original ya que no se especificó uno nuevo.
    setupFee: "Adminsitración hasta $2.000.000 CLP mensuales en inversión publicitaria.",
    description: "Para negocios con objetivos ambiciosos.",
    features: [
      "Campañas Google Search (Red de Búsqueda)",
      "Campañas Performance Max",
      "Campañas Meta (Facebook / Instagram)",
      "Gráficas y Videos con IA",
      "Marcación GTM, GA4 y Ads.",
      "Dashboard de resultados full funnel",
      "Asistencia prioritaria vía correo y Whatsapp",
    ],
    cta: "Elegir Plan Pro"
  },
];
